...
const (
	OrganizationService_ListOrganizations_FullMethodName           = "/larec.OrganizationService/ListOrganizations"
	OrganizationService_CreateOrganization_FullMethodName          = "/larec.OrganizationService/CreateOrganization"
	OrganizationService_DeleteOrganization_FullMethodName          = "/larec.OrganizationService/DeleteOrganization"
	OrganizationService_ListOrganizationMembers_FullMethodName     = "/larec.OrganizationService/ListOrganizationMembers"
	OrganizationService_GetOrganizationSymmetricKey_FullMethodName = "/larec.OrganizationService/GetOrganizationSymmetricKey"
	OrganizationService_AddUserToOrganization_FullMethodName       = "/larec.OrganizationService/AddUserToOrganization"
	OrganizationService_RemoveUserFromOrganization_FullMethodName  = "/larec.OrganizationService/RemoveUserFromOrganization"
)
...
type OrganizationServiceClient interface {
	...
	GetOrganizationSymmetricKey(ctx context.Context, in *GetOrganizationSymmetricKeyRequest, opts ...grpc.CallOption) (*GetOrganizationSymmetricKeyResponse, error)
...
func (c *organizationServiceClient) GetOrganizationSymmetricKey(ctx context.Context, in *GetOrganizationSymmetricKeyRequest, opts ...grpc.CallOption) (*GetOrganizationSymmetricKeyResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetOrganizationSymmetricKeyResponse)
	err := c.cc.Invoke(ctx, OrganizationService_GetOrganizationSymmetricKey_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrganizationServiceServer interface {
	...
	GetOrganizationSymmetricKey(context.Context, *GetOrganizationSymmetricKeyRequest) (*GetOrganizationSymmetricKeyResponse, error)
...
func (UnimplementedOrganizationServiceServer) GetOrganizationSymmetricKey(context.Context, *GetOrganizationSymmetricKeyRequest) (*GetOrganizationSymmetricKeyResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetOrganizationSymmetricKey not implemented")
}
...
func _OrganizationService_GetOrganizationSymmetricKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetOrganizationSymmetricKeyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrganizationServiceServer).GetOrganizationSymmetricKey(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrganizationService_GetOrganizationSymmetricKey_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrganizationServiceServer).GetOrganizationSymmetricKey(ctx, req.(*GetOrganizationSymmetricKeyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var OrganizationService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "larec.OrganizationService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetOrganizationSymmetricKey",
			Handler:    _OrganizationService_GetOrganizationSymmetricKey_Handler,
		},
		{
	...
	Metadata: "v1/organization_service.proto",
}
